...
if(BENCHMARK_FOUND)
    message(STATUS ${Green}"Found Benchmark include dir - ${BENCHMARK_INCLUDE_DIR}"${ColourReset})
    message(STATUS ${Green}"Found Benchmark library dir - ${BENCHMARK_LIBRARY_DIR}"${ColourReset})
else()
